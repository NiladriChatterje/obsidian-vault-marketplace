...
import { EMPTY_PAYOUT_DETAILS, PAYOUT_FIELDS, normalizePayoutDetails, validatePayoutDetails } from '@shared/lib/payouts';
import { useAuth } from '@shared/store/auth';
import type { PayoutDetails } from '@shared/types';
